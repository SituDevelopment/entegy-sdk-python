...
def getProfileType(self, name):
        ...
        print(data)
        resp = requests.post(self.APIEndpoint+"/v2/ProfileType", headers=self.headers, data=json.dumps(data))
        if resp == None:
...
def createProfileType(self, profileType):
    ...
    print(data)
    resp = requests.post(self.APIEndpoint+"/v2/ProfileType/Create", headers=self.headers, data=json.dumps(data))
    if resp == None:
        raise Exception("No reponse received from API")
    output = resp.json()
    return output
...
def updateProfileType(self, name, profileType):
    ...
    print(data)
    resp = requests.post(self.APIEndpoint+"/v2/ProfileType/Update", headers=self.headers, data=json.dumps(data))
    if resp == None:
        raise Exception("No reponse received from API")
    output = resp.json()
    return output
...
def deleteProfileType(self, name):
    ...
    print(data)
    resp = requests.delete(self.APIEndpoint+"/v2/ProfileType/Delete", headers=self.headers, data=json.dumps(data))
    if resp == None:
        raise Exception("No reponse received from API")
    output = resp.json()
    return output
...
def allProfileTypes(self):
    ...
    print(data)
    resp = requests.post(self.APIEndpoint+"/v2/ProfileType/All", headers=self.headers, data=json.dumps(data))
    if resp == None:
        raise Exception("No reponse received from API")
    output = resp.json()
    return output